...
from backend.app.schemas.vulnerability import PayloadGenerateRequest, PayloadGenerateResponse
...
from backend.app.services.reporting.pdf_generator import PDFGenerator
